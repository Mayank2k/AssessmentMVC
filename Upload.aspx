<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upload.aspx.cs" Inherits="AssessmentMVC.Upload" %>
...
<body>
    ...
    <div>
         <asp:Label ID="Label1" runat="server" Text="Please select school and file to upload the data:" Font-Bold="True" Font-Overline="False" Font-Size="X-Large" Font-Underline="True"/>
         <br />
         <br />
